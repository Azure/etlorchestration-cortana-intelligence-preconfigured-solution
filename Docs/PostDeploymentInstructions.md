...
The following document describes details on the **Data Warehousing and Modern BI** technical pattern deployed via [Cortana Intelligence Solutions](https://start.cortanaintelligence.com/). It covers the following: 
